-- Migration: Add playbooks table for storing trading strategies
-- Description: Playbooks are user-defined trading strategies with custom rules, icons, and colors
