-- Migration: Add shared_journals table for public journal sharing
-- Description: Allows users to generate public share links for journal entries with expiration
...
DROP POLICY IF EXISTS "Users can view their own shares" ON public.shared_journals;
DROP POLICY IF EXISTS "Users can create shares for their journals" ON public.shared_journals;
DROP POLICY IF EXISTS "Users can delete their own shares" ON public.shared_journals;
DROP POLICY IF EXISTS "Anyone can view non-expired shared journals" ON public.shared_journals;
