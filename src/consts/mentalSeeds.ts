...
export type MentalCategory = 'fear' | 'greed' | 'tilt' | 'fomo' | 'hesitation' | 'overconfidence' | 'discipline';
 ...
 */
export function getSeedsByCategory(category: 'fear' | 'greed' | 'tilt' | 'all'): MentalSeedProfile[] {
    switch (category) {
        case 'fear':
            return FEAR_SEEDS;
        case 'greed':
