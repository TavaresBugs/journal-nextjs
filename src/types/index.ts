...
export const DEFAULT_STRATEGIES = ["Pullback", "Breakout", "Reversal", "Trend Following"];

export const DEFAULT_SETUPS = ["Pivô de Alta", "Pivô de Baixa", "FVG", "Order Block", "Breaker"];
