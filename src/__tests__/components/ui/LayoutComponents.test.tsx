...
describe("Layout Components", () => {
  describe("ModalFooterActions", () => {
    ...
    it("should render custom buttons", () => {
      render(
        <ModalFooterActions mode="custom">
    ...
    it("should render create-close mode", () => {
      render(
        <ModalFooterActions mode="create-close" onPrimary={() => {}} onSecondary={() => {}} />
      );
  ...
  describe("Tabs", () => {
    ...
    it("should render TabPanel only when active", () => {
      render(
        <>
          <TabPanel value="tab1" activeTab="tab1">
            Panel 1
          </TabPanel>
          <TabPanel value="tab2" activeTab="tab1">
            Panel 2
          </TabPanel>
        </>
      );
