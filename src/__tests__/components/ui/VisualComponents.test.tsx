...
import { GlassCard, GlassCardHeader, GlassCardTitle, GlassCardFooter } from "@/components/ui/GlassCard";
...
describe("UI Components Part 2", () => {
  ...
  describe("CircularProgress", () => {
    ...
    it("should have correct stroke calculation in SVG", () => {
       const { container } = render(<CircularProgress percentage={50} size={100} strokeWidth={10} />);
  ...
  describe("GlassCard", () => {
      ...
      it("should apply hover effects", () => {
          const { container } = render(<GlassCard hover glow>Content</GlassCard>);
          expect(container.firstChild).toHaveClass("hover:bg-zorin-bg/80");
