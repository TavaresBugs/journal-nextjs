...
export const mockJournalWithImages = createMockJournalEntry({
    images: [
        { id: "img-1", userId: "user-123", journalEntryId: "journal-1", url: "img1.jpg", path: "path/img1.jpg", timeframe: "H1", displayOrder: 0, createdAt: new Date().toISOString() },
        { id: "img-2", userId: "user-123", journalEntryId: "journal-1", url: "img2.jpg", path: "path/img2.jpg", timeframe: "M15", displayOrder: 1, createdAt: new Date().toISOString() }
    ]
});
