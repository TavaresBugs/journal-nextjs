    ...
    return (
        <div className="relative">
            ...
            >
                ...
                <path
                    d="M 140 180 L 140 70 Q 155 50 170 45 L 170 180 Z"
                    fill="#f97316"
                    opacity="0.3"
                />
                ...
                <path
                    d="M 230 180 L 230 45 Q 245 50 260 70 L 260 180 Z"
                    fill="#f97316"
                    opacity="0.3"
                />
            ...
            <div className="flex justify-around mt-3 text-xs">
                <div className="text-center">
                    <div className="text-red-400 font-bold">{percentC}%</div>
                    <div className="text-gray-500">C-Game</div>
                </div>
                <div className="text-center">
                    <div className="text-orange-400 font-bold">{percentB}%</div>
                    <div className="text-gray-500">B-Game</div>
                </div>
                <div className="text-center">
                    <div className="text-green-400 font-bold">{percentA}%</div>
