  ...
  return (
    <div className="flex flex-col items-center justify-center">
      <div className="relative h-48 w-48">
        <svg height="192" width="192" viewBox="0 0 100 100" className="-rotate-90 transform">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center">
          {isZeroState ? (
            <span className="px-4 text-xs font-medium text-gray-500">Selecione argumentos</span>
          ) : (
            <>
              <span
                className={`text-3xl font-bold ${bullishPct >= 50 ? "text-emerald-400" : "text-red-400"}`}
              >
      ...
      {!isZeroState && (
        <div
          className="animate-fadeIn mt-4 flex gap-6 opacity-0"
